...
export const TicketModalGlobal = ({ ticketId }) => {
    ...
    <div className="fixed inset-0 z-[499] flex items-center justify-center bg-black/30 backdrop-blur-sm">
      <div className="h-[95%] bg-gray-100 rounded-xl shadow-lg w-[95%] sm:w-[80%] md:w-[75%] lg:w-[70%] xl:w-[70%] 3xl:w-[60%] py-4 px-5">
        <div className="h-full w-full flex flex-col relative">
          {/* Header */}
          <div className="flex items-center justify-between border-b pb-2 mb-3 w-full">
            <h3 className="text-lg font-semibold">
              Ticket: {ticketSubject || "Loading..."}
            </h3>
