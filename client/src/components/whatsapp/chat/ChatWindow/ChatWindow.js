...
export default function ChatWindow({ users, chat, team, updateConversation }) {
  ...
  const customStyles = {
    ...
    menu: (provided) => ({ ...provided, border: "1px solid #ccc" }),
  ...
  return (
    <div className="flex flex-col h-full z-10 font-inter bg-[#efeae2]">
      {/* Header Panel */}
      <div className="h-16  px-4 py-2 bg-white border-b border-gray-200 flex items-center justify-between gap-4 shadow-sm z-30">
        ...
        {/* <div className="flex-1">
          ...
          className={`${style.input} w-full h-[2.6rem] flex items-center justify-center px-0 py-0`}
            value={
              waTemplateOptions.find(
                (o) => o.value === selectedWaTemplate?.id,
              ) || null
            }
      ...
      <div
        ...
        className="flex-1 overflow-y-auto p-4 flex flex-col-reverse gap-4 custom-scrollbar bg-opacity-40 relative"
      >
        {(() => {
              ...
              <React.Fragment key={msg._id || idx}>
                ...
                <div
                  ...
                  className={`flex flex-col group transition-all duration-500 relative ${
                    ...
                    isHighlighted
                      ? "bg-orange-500/10 scale-[1.01] rounded-lg p-1.5"
                      : ""
                  }`}
                >
                  <div
