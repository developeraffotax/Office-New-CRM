...
const ActionsCell = ({
  ...
  return (
    <div className="flex items-center justify-center gap-2 w-full h-full">
      ...
      {/* Mark Completed / Mark In Progress (toggle) */}
      {progressStatus === "completed" ? (
        ...
        >
          <IoPlayOutline className="h-5 w-5 text-blue-500 hover:text-blue-600" />
        </span>
      ) : (
        <span
          className="text-[1rem] cursor-pointer"
        ...
        >
          <IoCheckmarkDoneOutline className="h-5 w-5 text-green-500 hover:text-green-600" />
        </span>
      )}
