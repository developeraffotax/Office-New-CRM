...
import UserLabelModal from "../user/UserLabelModal";

const Users = forwardRef(({childRef, setIsload}, ref) => {
  ...
  return (
    <>
      <div className=" relative w-full h-[100%] py-2 px-2 sm:px-4 overflow-y-auto">
        <div className="flex items-center justify-end gap-4 ">
          <div className="flex items-center gap-4">
            <span
              className={` p-1 rounded-md hover:shadow-md bg-gray-50    cursor-pointer border ${
                showDepartmentFilter && "bg-orange-500 text-white "
              }  `}
              onClick={() => {
