...
export default function CommentList({ conversationId, threadSubject, currentUserId, onClose, users, show }) {
...
const [refreshing, setRefreshing] = useState(false);
  ...
  console.log("COMMENTS IN COMMNETLIST🧡🧡🧡🧡🧡✌️✌️✌️✌️✌️", comments, conversationId)
...
useOverlayStack({
  ...
  return (
    <div className="fixed font-inter inset-0 z-[99999] pointer-events-none" ref={commentRef}>
      {/* Background */}
      <div
