...
if (loading) {
  ...
  return (
    ...
    >
      <div id="mainnnnnnn" className="w-full flex flex-row justify-start gap-5 items-start h-[50%]">
                    ...
                    <Droppable droppableId="subTaskData">
                      {(provided) => (
                        <ul
                          ...
                          style={{ listStyle: "none", padding: 0, overflowY: "scroll", maxHeight: "100%"  }}
                        >
                          {subTaskData?.map(
...
<div id="mainnnsnnnssn" className="w-full flex flex-row justify-start gap-5 items-start h-[50%]">
