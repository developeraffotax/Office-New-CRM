...
export const createBillingStartColumn = ({   handleUpdateSubscription }) => ({
      ...
      <div className="w-full ">
        {!showYearend ? (
          <p onDoubleClick={() => setShowYearend(true)}>
            {billingStart && format(new Date(billingStart), "dd-MMM-yyyy")}
          </p>
        ) : (
          <input
            type="date"
...
export default createBillingStartColumn;
