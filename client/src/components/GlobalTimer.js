    ...
    <div className="relative font-google">
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-full transition-all duration-200 hover:bg-gray-100 hover:shadow-sm flex items-center gap-2 px-2 py-1">
        ...
        <button
          onClick={openPopup}
          disabled={stopping}
          className="shrink-0 flex items-center justify-center w-[18px] h-[18px] rounded-full bg-gray-100 text-gray-300 hover:text-red-500 hover:bg-red-100 transition-colors duration-150 disabled:opacity-50"
        >
